# PojavTT-WIKI
💬 Join the community: discord.gg/QS3NpPM2dB
...
Download Fabric API for 1.21.11 and place it in your mods folder.
Drop the pojavtiertagger-*.jar into your mods folder.
(Optional) Install Mod Menu if you want an in-game settings screen.
Launch the game.
Configuration
...
License
MIT License — see LICENSE for the full text. You're free to use, modify, and redistribute this mod, including in modpacks, provided the original copyright and license notice are retained.
